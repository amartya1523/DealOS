...
- `OrganizationMembership` owns an organization access class, business role and lifecycle status. Business routes resolve this context server-side and add `organizationId` to every tenant-owned query.
