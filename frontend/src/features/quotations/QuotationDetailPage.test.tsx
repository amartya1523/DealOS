...
describe('quotation detail lifecycle',()=>{
  it('marks edits dirty and saves them before submitting',async()=>{
    ...
    expect(mutationUrls.slice(0,2)).toEqual(['/api/v1/quotations/quote-1/draft','/api/v1/quotations/quote-1/submit']);
