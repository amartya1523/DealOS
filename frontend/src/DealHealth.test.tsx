...
const workspace = { user: { id: "admin-1", name: "Admin", email: "admin@example.com", role: "ADMIN", moduleAccess: [], actorType: "USER", platformSuperAdmin: false, viewContext: null }, organization: { id: "org-1", name: "Acme" }, users: [], quotes: [quote], products: [], policies: [], warehouses: [], subscriptions: [], invoices: [], alerts: [alert], audits: [] } as Workspace;
